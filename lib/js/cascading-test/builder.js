(function() {
  ...
  require({
    ...
    return describe("job builder", function() {
      ...
      it("should propagate fields correctly for map spec", function() {
        return with_test_flow(function($) {
          ...
          return $.assembly('input', function() {
            var insert_step;
            insert_step = $.each_step({
              upcase: null,
              offset: "line_number",
              line: null
            }, function(tuple, emitter) {
              return emitter({
      ...
      return it("should exception if trying to rename an invalid field", function() {
        return expect_bad_flow("Invalid field bogus being renamed to line_number", function($) {
          $.source('input', $.tap("listings.txt", new schemes.TextLine("offset", "line")));
          return $.assembly('input', function() {
            return $.each_step({
              bogus: "line_number",
