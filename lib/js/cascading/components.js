    ...
    return {
      ...
      Pipe: Pipe = (function() {
        ...
        Pipe.process_tuples = function(pipe_id, in_buffer, in_buffer_length, operation, call, delimiter, terminator) {
          var buffer_flush_size, buffer_padding, entry, field, finalizer, group_field_values, group_fields, i_group_field, idx, in_buffer_fields, is_group_by, num_fields, out_buffer, out_buffer_fields, out_buffer_length, pipe, processor, tuple, tuple_length, value, writer, _ref, _ref2;
          ...
          writer = function(t) {
            ...
            if (is_group_by) {
              for (field in group_field_values) {
                value = group_field_values[field];
