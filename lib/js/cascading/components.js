    ...
    return {
      ...
      Pipe: Pipe = (function() {
        ...
        Pipe.get_flush_routine = function(in_buffer, out_buffer, pipe_id) {
          var current_group, finalizer, group_fields, initialized, initializer, non_group_in_fields, non_group_out_fields, num_group_fields, pipe, processor, stub_fields, tuple, writer, _i, _results;
          pipe = Pipe.pipes[pipe_id];
