    ...
    return {
      ...
      Pipe: Pipe = (function() {
        ...
        Pipe.process_tuples = function(pipe_id, in_buffer, in_buffer_length, operation, call) {
          var argument_selector_length, buffer_flush_size, i_field, i_tuple, idx, out_buffer, out_buffer_length, processor, tuple, _ref, _results;
          processor = Pipe.pipes[pipe_id].processor;
          buffer_flush_size = 8 * 1024;
          out_buffer = new Array(buffer_flush_size + 256);
          out_buffer_length = 0;
          argument_selector_length = Pipe.argument_selector.length;
          if (typeof flush === "undefined" || flush === null) {
            flush = operation.flushFromV8;
          }
          tuple = {};
          _results = [];
          for (i_tuple = 0, _ref = in_buffer_length / argument_selector_length; 0 <= _ref ? i_tuple < _ref : i_tuple > _ref; 0 <= _ref ? i_tuple++ : i_tuple--) {
            for (i_field = 0; 0 <= argument_selector_length ? i_field < argument_selector_length : i_field > argument_selector_length; 0 <= argument_selector_length ? i_field++ : i_field--) {
