  ...
  define(["underscore"], function(_) {
    ...
    return {
      ...
      Pipe: Pipe = (function() {
        ...
        Pipe.process_tuples = function(pipe_id, group_count, tuple_count, pkg, call, delimiter) {
          var arg_field_types, arg_null_mask, finalizer, group_field_types, group_fields, group_null_mask, group_sizes, in_buffer_fields, is_group_by, out_buffer_fields, package_data_index, pipe, processor, tuple, _ref;
