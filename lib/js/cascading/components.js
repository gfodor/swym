  ...
  define(["underscore"], function(_) {
    ...
    return {
      ...
      Pipe: Pipe = (function() {
        ...
        Pipe.process_tuples = function(pipe_id, in_buffer, in_buffer_length, operation, call, delimiter, terminator) {
          var buffer_flush_size, entry, field, finalizer, group_field_values, group_fields, i_group_field, idx, in_buffer_fields, is_group_by, is_terminator, num_fields, out_buffer, out_buffer_fields, out_buffer_length, pipe, processor, tuple, tuple_length, writer, _i, _len, _ref, _ref2;
          ...
          tuple = {};
          tuple_length = 0;
          group_fields = (_ref = pipe.group_fields) != null ? _ref : [];
          in_buffer_fields = _.difference(pipe.incoming, group_fields);
          out_buffer_fields = _.difference(pipe.outgoing, group_fields);
          is_group_by = pipe.is_group_by != null;
          group_field_values = {};
          writer = function(t) {
            var field, _i, _j, _len, _len2, _ref2;
            for (_i = 0, _len = out_buffer_fields.length; _i < _len; _i++) {
              field = out_buffer_fields[_i];
              out_buffer[out_buffer_length] = (_ref2 = t[field]) != null ? _ref2 : null;
              out_buffer_length += 1;
            }
            if (is_group_by) {
              for (_j = 0, _len2 = group_fields.length; _j < _len2; _j++) {
                field = group_fields[_j];
          ...
          for (idx = 0; 0 <= in_buffer_length ? idx < in_buffer_length : idx > in_buffer_length; 0 <= in_buffer_length ? idx++ : idx--) {
            entry = in_buffer[idx];
            is_terminator = is_group_by && entry === terminator;
            if (is_group_by && (idx === 0 || is_terminator)) {
              if (is_terminator) finalizer(writer);
              idx += 1;
              for (i_group_field = 0, _ref2 = group_fields.length; 0 <= _ref2 ? i_group_field < _ref2 : i_group_field > _ref2; 0 <= _ref2 ? i_group_field++ : i_group_field--) {
              ...
              tuple_length += 1;
              if (tuple_length === in_buffer_fields.length) {
                if (is_group_by) {
                  for (_i = 0, _len = group_fields.length; _i < _len; _i++) {
                    field = group_fields[_i];
      ...
      GroupBy: GroupBy = (function(_super) {
        ...
        function GroupBy(assembly, group_fields, spec, processor, finalizer) {
          var _ref, _ref2;
        ...
        GroupBy.prototype.connect_to_incoming = function(incoming) {
          var add_field, group_field, k, v, _i, _j, _len, _len2, _ref, _ref2, _ref3, _results;
          ...
          for (_j = 0, _len2 = _ref3.length; _j < _len2; _j++) {
            add_field = _ref3[_j];
            _results.push(this.outgoing[this.outgoing.length] = add_field);
          }
          return _results;
        };
