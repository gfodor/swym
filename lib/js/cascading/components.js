  ...
  define(["underscore"], function(_) {
    ...
    return {
      ...
      Pipe: Pipe = (function() {
        ...
        Pipe.registerPipe = function(pipe) {
        ...
        Pipe.processTuples = function(pipe_id, in_buffer, in_buffer_length, operation, call) {
          var buffer_flush_size, i_field, i_tuple, idx, out_buffer, out_buffer_length, processor, tuple, _ref, _ref2, _results;
          ...
          tuple = {};
          _results = [];
          for (i_tuple = 0, _ref = in_buffer_length / Pipe.argument_selector.length; 0 <= _ref ? i_tuple < _ref : i_tuple > _ref; 0 <= _ref ? i_tuple++ : i_tuple--) {
            for (i_field = 0, _ref2 = Pipe.argument_selector.length; 0 <= _ref2 ? i_field < _ref2 : i_field > _ref2; 0 <= _ref2 ? i_field++ : i_field--) {
              idx = (i_tuple * Pipe.argument_selector.length) + i_field;
              tuple[Pipe.argument_selector[i_field]] = in_buffer;
            }
            processor(tuple, function(t) {
              var field, _i, _len, _ref3, _ref4;
              _ref3 = Pipe.result_fields;
              for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
                field = _ref3[_i];
                out_buffer[out_buffer_length] = (_ref4 = t[field]) != null ? _ref4 : null;
                out_buffer_length += 1;
              }
            ...
            _results.push(flush.apply(operation, [out_buffer, out_buffer_length, call]));
          }
          return _results;
        };
      ...
      Each: Each = (function(_super) {
        ...
        Each.prototype.to_java = function(parent_pipe) {
          ...
          if (this.type === EachTypes.GENERATOR) {
            parent_jpipe = (_ref = this.parent_pipe) != null ? _ref.to_java() : void 0;
            return Cascading.Factory.Each(this.argument_selector, this.result_fields, Cascading.EnvironmentArgs, this.pipe_id, parent_jpipe);
          }
        };
      ...
      EachStep: EachStep = (function() {
        ...
        EachStep.prototype.connect_to_incoming = function(incoming) {
          var field, _i, _j, _len, _len2, _ref, _ref2, _results;
