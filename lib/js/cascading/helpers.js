  ...
  define(["./components", "./schemes"], function(components, schemes) {
    return {
      Components: {
        ...
        foreach_group: function(fields, params, initializer, processor, finalizer) {
          if (typeof fields === "string") fields = [fields];
          return new components.GroupBy(this.current_assembly(), fields, params, initializer, processor, finalizer);
        },
